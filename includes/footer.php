...
<div class="modal fade p-0" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog login_dialog">
        <div class="modal-content login_modal modal-dialog-centered">
            ...
            <div class="modal-body">
                ...
                <form action="dashboard.php">
                    ...
                    <div class="button-container-2">
                        ...
                        <button type="sumbit" name="Hover">Login</button>
                    </div>
                ...
                <div class="gs_body">
                    ...
                    <div>
                        ...
                        <a href="dashboard_event_listing.php" class="button-container-2 d-inline-flex">
                            ...
                            <button type="submit" name="Hover">BACK TO EVENTS</button>
                        </a>
                    </div>
                </div>
            </div>
                    ...
                    <div>
                        ...
                        <div class="rc_btn">
                            <a href="dashboard_edit_group.php" class="button-container-2 d-inline-flex">
                                ...
                                <button type="submit" name="Hover">YES</button>
                            </a>
                            <a href="dashboard_edit_group.php" class="button-container-2 d-inline-flex">
                                <span class="mas">NO</span>
                                <button type="submit" name="Hover">NO</button>
                            </a>
                        </div>
                    </div>
                </div>
